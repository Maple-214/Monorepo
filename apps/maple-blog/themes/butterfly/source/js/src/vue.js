...
!(function (t, e) {
  ...
  function Oe(t, n, r, o) {
    ...
    return (
      o.proxy && Object.defineProperty(n, r, { get: i, enumerable: !0, configurable: !0 }),
      i
    );
  }
  function Te(t, e) {
    ...
    Xn = (function () {
      ...
      return (
        ...
        (t.prototype.teardown = function () {
          if (
            (this.vm && !this.vm._isBeingDestroyed && y(this.vm._scope.effects, this), this.active)
          ) {
  ...
  function _r(t, e, n) {
    ...
    for (var r, o, i, a = ct ? Reflect.ownKeys(e) : Object.keys(e), s = 0; s < a.length; s++)
      '__ob__' !== (r = a[s]) &&
        ((o = t[r]), (i = e[r]), n && b(t, r) ? o !== i && u(o) && u(i) && _r(o, i) : Nt(t, r, i));
    return t;
  }
  function br(t, e, n) {
    return n
      ...
      (function (t, n) {
        ...
        if (r) {
          var o,
            ...
            a = {};
          if (e(r))
            for (o = r.length; o--; ) 'string' == typeof (i = r[o]) && (a[x(i)] = { type: null });
  ...
  var $i,
    ...
    ki = ['Webkit', 'Moz', 'ms'],
    Si = $(function (t) {
      if ((($i = $i || document.createElement('div').style), 'filter' !== (t = x(t)) && t in $i))
        return t;
      ...
      if (!n(e)) {
        ...
        if (n(t)) ((u = !0), d(e, f));
          ...
          if (!p && mo(t, e)) k(t, e, f, null, null, a);
            ...
            if (p) {
              if (
                (1 === t.nodeType && t.hasAttribute(R) && (t.removeAttribute(R), (i = !0)),
                o(i) && T(t, e, f))
              )
                return (S(e, f, !0), t);
  ...
  function Xs(t) {
    ...
    if (t.modifiers) {
      ...
      (a.length &&
        (o += (function (t) {
          return (
            "if(!$event.type.indexOf('key')&&" + ''.concat(t.map(Ys).join('&&'), ')return null;')
          );
        })(a)),
        i && (o += i));
      var u = e
